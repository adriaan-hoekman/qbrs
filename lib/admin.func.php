...
// if on mobile device, redirect to cyclist page
...
// add admin if valid netid is passed and netid isn't already an admin.
...
// remove admin if valid netid is passed and user is not the last admin or user's netid equals passed netid
...
// returns 0 if user is not receiving emails and 1 otherwise
...
// utility function for downloadable spreadsheets
...
// generates mysql query for downloadable spreadsheets
...
// downloads generated spreadsheet
...
// downloads custom generated spreadsheet
